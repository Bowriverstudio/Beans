...
/* harmony import */ var _plugins_body_container__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./plugins/body-container */ "./src/plugins/body-container/index.js");
/* harmony import */ var _plugins_layout_default__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./plugins/layout-default */ "./src/plugins/layout-default/index.js");
/* harmony import */ var _plugins_layout_meta__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./plugins/layout-meta */ "./src/plugins/layout-meta/index.js");
/* harmony import */ var _plugins_remove_action__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./plugins/remove_action */ "./src/plugins/remove_action/index.js");
/* harmony import */ var _plugins_onboarding__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./plugins/onboarding */ "./src/plugins/onboarding/index.js");
 //
...
/***/ "./src/plugins/body-container/index.js":
/*!*********************************************!*\
  !*** ./src/plugins/body-container/index.js ***!
  \*********************************************/
/*! no exports provided */
...
var genesisLayoutToggleComponent =
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(genesisLayoutToggleComponent, _Component);

  function genesisLayoutToggleComponent(props) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, genesisLayoutToggleComponent);

    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(genesisLayoutToggleComponent).call(this, props));
    console.log(props);
    _this.state = {
      containerOptions: []
    };
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(genesisLayoutToggleComponent, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;

      _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_11___default()({
        path: '/beans/v1/containers'
      }).then(function (collection) {
        var stack = [];

        for (var _i = 0, _Object$keys = Object.keys(collection); _i < _Object$keys.length; _i++) {
          var slug = _Object$keys[_i];
          stack.push({
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["Fill"], {
        name: "BeansSidebar"
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["Panel"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["PanelBody"], {
        initialOpen: true,
        title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('Container Width', 'tm-beans')
      }, // console.log(this.state.containerOptions);
      this.state.containerOptions.length ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["SelectControl"], {
        label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('Select Layout', 'tm-beans'),
        value: this.props.container,
        options: this.state.containerOptions,
        onChange: function onChange(container) {
          return _this3.props.onChange(container);
        }
      }) : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__["Spinner"], null)))));
    }
  }]);

  return genesisLayoutToggleComponent;
}(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["Component"]); // Retrieves meta from the Block Editor Redux store (withSelect) to set initial checkbox state.
...
var render = Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_7__["compose"])([Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_8__["withSelect"])(function () {
  return {
    container: Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_8__["select"])('core/editor').getEditedPostAttribute('meta')._beans_body_container
  };
}), Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_8__["withDispatch"])(function (dispatch) {
  return {
    onChange: function onChange(container) {
      dispatch('core/editor').editPost({
        meta: Object(_lib_new_meta_js__WEBPACK_IMPORTED_MODULE_12__["newMeta"])('_beans_body_container', container)
      });
    }
  };
})])(genesisLayoutToggleComponent);
Object(_wordpress_plugins__WEBPACK_IMPORTED_MODULE_9__["registerPlugin"])('beans-body-container', {
  render: render
});
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(BeansDefaultLayout, [{
    ...
    value: function render() {
      ...
      if (!this.state || !this.state.layoutSelected) {
        var label = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_7__["__"])('Loading', 'tm-beans'), 'test');
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("p", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("span", null, label), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__["Spinner"], null));
      }
...
/***/ "./src/plugins/onboarding/index.js":
/*!*****************************************!*\
  !*** ./src/plugins/onboarding/index.js ***!
  \*****************************************/
/*! no exports provided */
...
function beansHideBreadcrumbsComponent(_ref) {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__["Fill"], {
    ...
    initialOpen: true,
    title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__["__"])('Onboarding', 'tm-beans')
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", null, "In Development")))));
} // Retrieves meta from the Block Editor Redux store (withSelect) to set initial checkbox state.
// Persists it to the Redux store on change (withDispatch).
// Changes are only stored in the WordPress database when the post is updated.
...
Object(_wordpress_plugins__WEBPACK_IMPORTED_MODULE_5__["registerPlugin"])('beans-onboarding', {
  render: render
});
...
/* harmony import */ var _lib_new_meta__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../lib/new-meta */ "./src/lib/new-meta.js");
...
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_6___default()(RemoveActionToggle, _Component);

  function RemoveActionToggle(props) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, RemoveActionToggle);

    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_3___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_4___default()(RemoveActionToggle).call(this, props));
    _this.getRemoveActionValue = _this.getRemoveActionValue.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5___default()(_this));
    _this.state = {};
    return _this;
  }
  /**
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(RemoveActionToggle, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
    ...
    value: function render() {
      ...
      var items = Object.entries(this.state.removeActionsOptions).map(function (_ref) {
        var _ref2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_ref, 2),
            key = _ref2[0],
            value = _ref2[1];

        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_11__["PanelRow"], {
          key: key
          ...
          label: 1 ? Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__["__"])(value['label'], 'tm-beans') : undefined,
          checked: _this3.getRemoveActionValue(value['key']),
          onChange: function onChange() {
            return _this3.props.onUpdate(_this3.props.beansRemoveActions, value['key'], !_this3.getRemoveActionValue(value['key']));
          }
        }));
      });
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["Fragment"], null, items);
    }
  }]);
...
var applyWithDispatch = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_10__["withDispatch"])(function (dispatch) {
  ...
  return {
    ...
    onUpdate: function onUpdate(beansRemoveActions, key, value) {
      ...
      dispatch('core/editor').editPost({
        meta: Object(_lib_new_meta__WEBPACK_IMPORTED_MODULE_13__["newMeta"])('_beans_remove_actions', myJSON)
      });
    }
  };
}); // Get current post type, label, and post ID from the Block Editor Redux store.

var BeansRemoveActionToggle = Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_9__["compose"])([Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_10__["withSelect"])(function () {
  return {
    beansRemoveActions: Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_10__["select"])('core/editor').getEditedPostAttribute('meta')._beans_remove_actions
  };
