...
/* harmony import */ var _plugins_default_layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./plugins/default-layout */ "./src/plugins/default-layout/index.js");
/* harmony import */ var _plugins_remove_action__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./plugins/remove_action */ "./src/plugins/remove_action/index.js");
...
function getSmallIconFromLayout() {
  var layout = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'c';
  var iconname = (_icon_mapping_json__WEBPACK_IMPORTED_MODULE_0__[layout] || 'c') + '_small';
  return _icons__WEBPACK_IMPORTED_MODULE_1__["default"][iconname];
}
...
/***/ "./src/plugins/default-layout/SwitcherButton.js":
/*!******************************************************!*\
  !*** ./src/plugins/default-layout/SwitcherButton.js ***!
  \******************************************************/
/*! exports provided: default */
...
/***/ "./src/plugins/default-layout/SwitcherControls.js":
/*!********************************************************!*\
  !*** ./src/plugins/default-layout/SwitcherControls.js ***!
  \********************************************************/
...
/* harmony import */ var _SwitcherButton__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./SwitcherButton */ "./src/plugins/default-layout/SwitcherButton.js");
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(SwitcherControler, [{
    ...
    value: function updateDefaultLayout(key) {
      ...
      _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_10___default()(putRequest).then(function (types) {
        console.log(_this3.props.onLayoutChange);
    ...
    value: function render() {
      ...
      console.log(this.state.layoutOptions);
      var items = Object.keys(this.state.layoutOptions).map(function (key) {
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(_SwitcherButton__WEBPACK_IMPORTED_MODULE_11__["default"], {
          iconKey: _this4.state.layoutOptions[key].icon,
...
/***/ "./src/plugins/default-layout/index.js":
/*!*********************************************!*\
  !*** ./src/plugins/default-layout/index.js ***!
  \*********************************************/
/*! no exports provided */
...
/* harmony import */ var _SwitcherControls_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./SwitcherControls.js */ "./src/plugins/default-layout/SwitcherControls.js");
...
function (_Component) {
  ...
  function BeansDefaultLayout() {
    ...
    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(BeansDefaultLayout).apply(this, arguments)); // console.log(this.props.currentPostType)
