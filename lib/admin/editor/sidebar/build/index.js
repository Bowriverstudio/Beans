...
function (_Component) {
  ...
  function SwitcherControler(props) {
    ...
    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(SwitcherControler).call(this, props)); // this.onChange = this.onChange.bind(this)
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(SwitcherControler, [{
    ...
    value: function updateDefaultLayout(key) {
      console.log(key);
      console.log(this.props.onLayoutUpdateDispatch); // const data = {
    ...
    value: function render() {
      ...
      if (!this.state.layoutOptions) {
        var label = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__["sprintf"])(Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('Disabling breadcrumbs on %s...', 'beans'), 'test');
...
var render = Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_11__["compose"])([applyWithSelect, applyWithDispatch // withDispatch( ( dispatch ) => ( {
